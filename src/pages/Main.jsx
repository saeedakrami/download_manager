...
class Main extends React.Component {
    ...
    setModalChildren = (modal) => {
        ...
        const modalComponent = [
            <Login handleLogin={this.handleLogin} handleCloseModal={() => this.setState({modalOpen: false})} registerClick={this.handleSignupClick} />, 
    ...
    setDownloadList = () => {
        ...
        let downloadList = Downloads.filter(
            val => val.user_ID === userLogin.ID && 
            (selectedTab !== 'All' ? val.tab === selectedTab : val.tab === 'Complete' || 'Incomplete') && 
